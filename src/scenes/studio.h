...
enum StudioSongsEnum {
    ...
    /* 45 */ STUDIO_SONG_DRUM_LESSON,
    /* 46 */ STUDIO_SONG_MARCHING_ORDERS_PRACTICE,
    /* 47 */ STUDIO_SONG_RAPMEN,
    /* 48 */ STUDIO_SONG_RAPWOMEN,
    /* 49 */ STUDIO_SONG_NINJA_BODYGUARD,
    /* 50 */ STUDIO_SONG_REMIX1,
    /* 51 */ STUDIO_SONG_REMIX2,
    /* 52 */ STUDIO_SONG_REMIX4,
    /* 53 */ STUDIO_SONG_KARATE_MAN_TEMPO_UP,
    /* 54 */ STUDIO_SONG_RHYTHM_TWEEZERS_TEMPO_UP,
    /* 55 */ STUDIO_SONG_MARCHING_ORDERS_TEMPO_UP,
    /* 56 */ STUDIO_SONG_SPACEBALL_TEMPO_UP,
    /* 57 */ STUDIO_SONG_CLAPPY_TRIO_TEMPO_UP,
    /* 58 */ STUDIO_SONG_REMIX1_TEMPO_UP,
